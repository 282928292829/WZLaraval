{{-- Guest login / register modal — standalone Livewire component. --}}
{{-- x-show with $wire guard prevents false display during Livewire morph. Default hidden so overlay never blocks clicks before Alpine runs. --}}
