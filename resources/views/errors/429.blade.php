...
<head>
    ...
    <title>{{ __('errors.429.title') }} — {{ \App\Models\Setting::get('site_name') ?? config('app.name') }}</title>
...
<body>
    <div class="card">
        ...
        <h1>{{ __('errors.429.title') }}</h1>
        <p>{{ __('errors.429.paragraph', ['minutes' => $retryAfterMinutes ?? 60]) }}</p>
        <div class="actions">
