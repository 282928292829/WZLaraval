<x-app-layout :minimal-footer="true">
    <div class="max-w-5xl mx-auto px-4 py-4 sm:py-6 space-y-4">
        ...
        <div class="flex items-center justify-between gap-2 text-xs mb-2">
            <span class="text-gray-500">{{ __('orders.all_orders') }} — Design 2</span>
        ...
        <div class="flex justify-center gap-1.5">
            <span class="inline-flex items-center gap-1 px-2.5 py-1 bg-white border border-gray-100 shadow-sm rounded-full text-xs">
                        ...
                        <div class="p-4">
                            <div class="grid grid-cols-2 gap-3">
                                <div>
                                    ...
                                    <span class="text-base font-bold text-gray-800">{{ $order->order_number }}</span>
                                </div>
                                <div>
                                ...
                                <div class="flex items-end justify-end">
                                    <span class="inline-flex items-center gap-1.5 px-3 py-1.5 text-xs font-semibold text-primary-600 bg-primary-50 border border-primary-200 rounded-lg">
