<x-app-layout :minimal-footer="true">
    ...
    <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div class="text-center mb-10">
            <h1 class="text-2xl sm:text-3xl font-bold text-gray-900 mb-2">{{ __('testimonials.title') }}</h1>
            <p class="text-gray-500">{{ __('testimonials.subtitle') }}</p>
        </div>
        ...
        <div x-data="testimonials()" @keydown.escape.window="close()">
                ...
                @foreach($images as $i => $img)
                    ...
                    >
                        <div class="relative aspect-square overflow-hidden bg-gray-100">
                            <img
                                src="{{ $img }}"
                                alt="{{ __('testimonials.caption', ['n' => $i + 1]) }}"
            ...
            >
                ...
                >
                    <img :src="currentImage" alt="{{ __('testimonials.title') }}" class="w-full h-auto max-h-[85vh] object-contain rounded-xl shadow-2xl" />
                </div>
            </div>
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-200 p-8 text-center max-w-xl mx-auto">
            <h2 class="text-2xl font-bold text-gray-900 mb-2">{{ __('testimonials.cta_title') }}</h2>
            <p class="text-gray-500 mb-6">{{ __('testimonials.cta_subtitle') }}</p>
